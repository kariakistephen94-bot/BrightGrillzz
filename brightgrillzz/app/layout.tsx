...
export const metadata: Metadata = {
  ...
  description:
    'Experience premium flame-grilled cuisine at BrightGrillzz. Open Mon to Sun, 9am to 6pm, in Wuse 2, Abuja. Royal Platter, Grilled Fish, Carne Asada, King Crab and more, order online or on WhatsApp.',
